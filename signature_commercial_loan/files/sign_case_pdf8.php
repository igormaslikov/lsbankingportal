...
<tbody>
<tr>
<td><span>To the right, you will find a Spanish-Language translation of our Arbitration Agreement. An independent third party has certified this translation. While it is our intention to provide an accurate translation, if the Spanish translation differs from the English Document; you understand and agree that the Spanish translation is provided solely as courtesy to you, and that the English Document is the legally binding agreement between you and us.</span>
<br>
<b>NOTICE OF ARBITRATION AGREEMENT</b><br><span>•	This agreement provides that either you or we may choose to have any dispute decided by BINDING ARBITRATION instead of court.
<br>
...
<br>
<b>FOR MORE DETAILS, PLEASE READ CAREFULLY THIS ARBITRATION AGREEMENT CAREFULLY.</b><br><span> In this Arbitration Agreement, “you” refers to the borrower(s). “we”, “us”, and “our” refers to LS Financing, Inc, our successors-in-interest and assigns. This arbitration agreement is incorporated into and is a part of a loan agreement between you and us.</span>
<br>
...
<td><span>A continuación, usted encontrara la traducción al español del nuestro Acuerdo de Arbitraje. Un tercero independiente ha certificado esta traducción. Aunque nuestra intención es proveerle una traducción exacta, si la traducción al español es destina al documento en ingles, usted entiende y está de acuerdo que esta traducción se brinda simplemente como una cortesía, y que el documento en el idioma ingles regirá legalmente la relación entre usted y nosotros</span>
<br>
<b>NOTIFICACION DE ACUERDO DE ARBITRAJE</b><br><span>•	Este acuerdo establece que tanto usted como nosotros podemos elegir que se decida una disputa por medio de ARBITRAJE OBLIGATORIO en lugar de un tribunal.
<br>
...
$pdf->Image('@' . $img, 35, 255, '30', '', 'JPG', '', 'T', false, 40, '', false, false, 0, false, false, false);
