 ...
 <table>
	...
	<tr>
		<td style="vertical-align:baseline;text-align:justify">
			<ul>
				<li style="padding-bottom:0.5em"><b style="font-size:14px;">Arbitration:</b><span style="font-size:14px;">. You acknowledge that you have read, understand and agree to the terms contained in the Arbitration Agreement you are signing in connection with this Agreement, by entering into the Arbitration Agreement you waive certain rights, including the right to go to court, to have a dispute heard by a jury, and to participate as part of a class o claimants relating to any claim against or dispute with us or a related third party.</span></li>
				<li style="padding-bottom:0.5em"><b style="font-size:14px;">Notices:</b><span style="font-size:14px;">We will send all notices to you at the address shown above. You understand and agree that you have a responsibility under California Civil Code Section 1788.21 to notify us of any change in your name, address, or employment within a reasonable time after such change occurs.</span></li>
				<li style="padding-bottom:0.5em"><b style="font-size:14px;">Presentations and Warranties:</b><span style="font-size:14px;">You represent and warrant to us that (a) all the information you provided to us in your credit application is true and correct (b) you have the legal capacity to enter into this Agreement; and (c) n persona has acted as a broker or finder for this transaction.</span></li>
				<li style="padding-bottom:0.5em"><b style="font-size:14px;">Returned Payment Charge; Collection Costs:</b><span style="font-size:14px;">You understand and agree that if, a payment check is returned unpaid for any reason, and you will pay us a returned payment charge of $25. You agree to pay us any court fees we incur in enforcing this Agreement.</span></li>
				<li style="padding-bottom:0.5em"><b style="font-size:14px;">Credit Reporting:</b><span style="font-size:14px;">You agree that we may make inquiries concerning your credit history and standing. We may report information concerning your performance under this Agreement to credit reporting agencies. Late payments, missed payments, or other defaults on your account may be reflected in your credit report. </span></li>
				<li style="padding-bottom:0.5em"><b style="font-size:14px;">Right to Rescind the Loan. :</b><span style="font-size:14px;">You may rescind your loan and cancel this Agreement by notifying us by the end of the business day following the day you sign this Agreement. if you rescind the loan, you must return to us the money that we lend you.</span></li>
			</ul>
		</td>
	</td>
	<td></td>
	...
	<td style="vertical-align:baseline;text-align:justify">
		<ul>
			<li style="padding-bottom:0.5em"><b style="font-size:14px;">Arbitraje:</b><span style="font-size:14px;">Usted confirma que ha leído, comprendido y convenido a los términos y condiciones contenidos en el acuerdo de arbitraje que firma en relación con este contrato. Al firmar el acuerdo de arbitraje usted renuncia a ciertos derechos, inclusive el derecho de acudir a un tribual solicitar que una disputa sea escuchada por un jurado y formar parte de un grupo de reclamantes en relación con cualquier reclamación o disputa contra nosotros u otra parte relacionada.</span></li>
			<li style="padding-bottom:0.5em"><b style="font-size:14px;">Avisos:</b><span style="font-size:14px;">Le enviaremos todos los avisos al domicilio indicada arriba. Usted comprende y conviene que tiene una responsabilidad conforme a la sección 1788.21 del código civil de California, de notificarnos de cualquier cambio de nombre, domicilio, o empleo dentro de un plaza razonable después de que ocurra dicho cambio.</span></li>
			<li style="padding-bottom:0.5em"><b style="font-size:14px;">Declaraciones y garantías:</b><span style="font-size:14px;">Usted nos declara y garantiza que (a) toda la información que nos ha proporcionado en su solicitud de crédito es veraz y correcta; (b) tiene la capacidad legal para firmar este contrato; y (c) ninguna persona ha actuado como corredor o fundir de esta transacción.</span></li>
			<li style="padding-bottom:0.5em"><b style="font-size:14px;">Cargo por Cheque Devuelto, costos de Cobranza:</b><span style="font-size:14px;">Usted comprende y conviene que si un cheque de pago es devuelto sin pagar, por la razón que sea, usted nos pagara un cargo por cheque devuelto de $25. Usted conviene en pagarnos todos los cargos de corte en que incurramos para la ejecución de este contrato.</span></li>
			<li style="padding-bottom:0.5em"><b style="font-size:14px;">Informes crediticios:</b><span style="font-size:14px;">Usted conviene que podremos realizar ciertas consultas sobre su historial de crédito y solvencia crediticia. Podremos proporcionar a agencias de informes crediticios información sobre su desempeño según este contrato. Retraso en los pagos, pagos incumplidos, y otros incumplimientos en esta obligación pueden ser reflejados en su informe e crédito.</span></li>
			<li style="padding-bottom:0.5em"><b style="font-size:14px;">Derecho a rescindir el préstamo:</b><span style="font-size:14px;">Usted puede rescindir su préstamo y cancelar este contrato notificándonos a más tardar al final del día hábil posterior al día en que usted formo este contrato. En caso de que rescinda el préstamo, deberá devolvernos todo el dinero del préstamo que haya recibido.</span></li>
		</ul>	
	<br>
	...
	<br><br><br>
	<span style="font-size:14px;"> By signing below, you acknowledge that (1) you have read and received copy of this Agreement; (2) you agree to the terms of this Agreement; (3) no person has acted as a broke in connection with the Agreement; (4) there are no other oral or written agreements or promises between you and us.
	...
	<br><br>
	<b style="font-size:14px;">LS Financing, Inc</b>
	<p style="font-size:10px;">California Finance Lender License: 60DBO-88277<br>
