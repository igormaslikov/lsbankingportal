...
<b style="font-size:8px;">AGREEMENT TO RECEIVE SMS: </b><span style="font-size:8px;">By signing this section, you authorize LS Financing, Inc or Our Agents to send marketing to the mobile number you have provided and that is listed below using and automatic dialing system, You are not required to authorize marketing SMS to obtain credit or other services from us. If you do not wish to receive, sales or marketing SMS from us, you should not sign this section. You understand that at any messages we send you may be accessed by anyone with access to your SMS. You also understand that your mobile phone service provider any charge you fees for any SMS that we send you, and you agree that we shall have no liability for any cost related to such SMS. At any time, you may withdraw your consent to receive marketing by calling us at (747) 300-1542. 
</span>
...
<br>
<b style="font-size:8px;">OPT-OUT o STOP:</b><span style="font-size:7px;">Esta Política de SMS se aplica a los mensajes de texto enviados por LS Financing a nuestros clientes mientras y después de que usan nuestro servicio. Si desea dejar de recibir SMS de LS Financing, Inc, responda a cualquier mensaje de texto que le hayamos enviado y, en su respuesta, simplemente escriba STOP. Su solicitud de detención entrará en vigencia de inmediato. También puede detener los SMS llamando, enviando una carta o envíenos un correo electrónico a la siguiente información: LS Financing, Inc 4645 Van Nuys Boulevard Suite 202 Sherman Oaks, CA 91403 info@lsbanking.com o (747) 300-1542.
</span><br>
