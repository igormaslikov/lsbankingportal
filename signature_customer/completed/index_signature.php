...
$sql=mysqli_query($con, "select * from loan_initial_banking"); 
...
$sql=mysqli_query($con, "select * from loan_initial_banking where email_key='$mail_key' "); 
...
<TITLE>bcl_1536563094.htm</TITLE>
...
<TR>
	<TD class="tr9 td20"><P class="p2 ft7">Signature of Borrower <?php echo $img;?> </P></TD>
