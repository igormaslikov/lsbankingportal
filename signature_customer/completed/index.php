...
$url="https://pacificafinancegroup.com/loanportal/signature_customer/files/sign_contract.php?id=$iddd";
...
?>
  ...
  <!--    	</form>-->
		 <!--<a href="mail_contarct.php?f_name=<?php echo $f_name;?>&l_name=<?php echo $f_name;?>&email=<?php echo $email;?>&mobile_number=<?php echo $mobile_number;?>&user_fnd_id=<?php echo $user_fnd_id;?>&url=<?php echo $url;?>"> <button id="" type="submit" name="finished"> Finished </button></a>-->
...
<iframe src="<?php echo $url_link; ?>"frameBorder="0" width="100%" height="900"></iframe>
<?php } ?>
