...
$sql=$con->query("select * from personal_loan_initial_banking where email_key='$idd' "); 
...
$sql_loan=$con->query("select * from tbl_personal_loans where loan_id= '$loan_id' "); 
...
<TR>
	...
	<TD colspan=2 class="tr10 td26"><P class="p25 ft15">NÃºmero de PrÃ©stamo: <span style="color:blue;"> <?php echo $loan_id; ?> </span></P></TD>
</TR>
<TR>
...
<TR>
	<TD class="tr11 td24"><P class="p2 ft15">DirecciÃ³n: <span style="color:blue;"> <?php echo $address; ?> </span></P></TD>
	<TD class="tr11 td25"><P class="p2 ft3">&nbsp;</P></TD>
	<TD class="tr11 td2"><P class="p2 ft3">&nbsp;</P></TD>
	<TD class="tr11 td27"><P class="p2 ft3">&nbsp;</P></TD>
</TR>
<TR>
	<TD class="tr1 td24"><P class="p2 ft15">CÃ³digo postal: <span style="color:blue;"> <?php echo $zip; ?> </span></P></TD>
...
<P class="p78 ft23">Yo , <span style="color:blue"> <?php echo $f_name;?> </span>, el abajo firmante de la tarjeta de crÃ©dito en mi nombre descrita</P>
