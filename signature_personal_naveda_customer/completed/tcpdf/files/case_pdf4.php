...
$style = array(
 ...
 $html = '
 <br><br><br>
Borrower Name/Nombre del Deudor: _________________________________________<br><br>
Loan Number/Numero de Prestamo: _________________________________________<br><br>
...
<div>
I (we) hereby authorize Pacifica Finance Group
...
remain in effect until Pacifica Finance Group is
notified by me (us) in writing to cancel it in
such time as to afford Pacifica Finance Group and
The Financial Institution a reasonable
opportunity to act on it. <br><br>

Yo (nosotros) autorizamos a Pacifica Finance Group a
...
vigor hasta que Pacifica Finance Group sea notificada
por escrito (por escrito) para cancelarla en el
tiempo que se dé a Pacifica Finance Group y La
Institución Financiera una oportunidad razonable
para actuar en ella. <br><br><br>


<b>Borrowers Name/Nombre del Deudor: </b>'.$f_name.'<br><br>
<b>Borrowers Address/Direccion del Deudor:</b> '.$address.'<br><br>
<b>Borrowers Bank/Banco del Deudor:</b> '.$bank_name.'<br><br>
<b>Borrowers Bank Routing Number: </b>'.$routing_number.'<br><br>
<b>Borrowers Bank Account Number:</b> '.$account_number.'<br><br>
<b>Payment Amount/Monto del Pago: $</b>'.$amount_of_loan.', Past Due Amount or Payoff/Monto Atrasado o saldar la cuenta. <br><br>
