...
Holder.<br><br>
AutorizaciÃ³n para hacer pagos en mi cuenta de <b>Optima Financial Solutions Inc</b> prestamo # <span style="text-decoration:underline">'.$loan_id_bor.'</span> sobre la base
continua utilizando la tarjeta de crÃ©dito que se describe a continuaciÃ³n y los tÃ©rminos de este prÃ©stamo , a menos
que se indique lo contrario por escrito por el titular de la Tarjeta de CrÃ©dito .
</div>
...
'."<img src='$result_sig' style='height:130%;width:35%;margin-bottom:-20%;' />".'<br><br>
...
$pdf->Image('@' . $img, 15, 242, '30', '', 'JPG', '', 'T', false, 40, '', false, false, 0, false, false, false);
