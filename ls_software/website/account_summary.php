...
<body> 
    ...
    <div align="right">
    <a class="theme_btn" href="#">Apply for another loan?</a>
        </div>
        
        <h3>You can see your account summary here.</h3>
        <p></p>
        ...
        <br>
            ...
            <div class="row">
            <div class="col-lg-6">
    <a class="theme_btn" href="#">List of previous loans</a>
    </div> 
    
     <div class="col-lg-6">
    <a class="theme_btn" href="#">Personal information</a>
    </div> 
