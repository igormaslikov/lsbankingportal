...
<body> 
    ...
    <br>
     ...
     <label for="usr">Password</label>
      <input name="password"  type="text" class="form-control" id="usr" placeholder="" value="">
    </div> 
    ...
    <button name="btn-submit" type="submit" class="theme_btn" href="" style="width:30%">Login</button>
