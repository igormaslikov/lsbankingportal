...
// if everything is ok, try to upload file
  ...
  //  echo "Sorry, there was an error uploading your file.";
    ...
    $target_file = "https://www.pacificafinancegroup.com/loanportal/ls_software/schedule_mms/".$target_file;
...
<?php echo date('M-D-Y h:m:i'); ?>
            ...
            <form class="form-horizontal" action="" method="post"
                ...
                <textarea name="message" style="margin: 0px; height: 267px; width: 491px;"required></textarea>
                
                <div class="input-row">
      <label for="usr">Date</label>
    <select name="date_name" id="date" class="form-control"  value=""required>
...
<option value="<?php echo date('m-d-Y',strtotime("+7 day"));?>"> <?php echo date('m-d-Y',strtotime("+7 day"));?> </option>
    ...
    <select name="time" id="date" class="form-control"  value=""required>
<option value=""></option>
...
<option value="12:00">12:00</option>
                ...
                <div class="input-row">
                    ...
                    <label class="col-md-4 control-label">Choose Image to Send</label> <input type="file" name="file_image"
                        id="file_image"required>
                        
                        
                        
                        
                    <button type="submit" id="submit" name="import"
                        class="btn-submit">Send Schedule MMS</button>
                    <br />
