...
if ($creation_date<$date_duplicate){
    ...
    $loan_transaction_id="";
mysqli_query($con, "UPDATE fnd_user_profile SET application_status='New Application', application_date='$to_date_filter', loan_type='$type_loan', website='$web_site' where user_fnd_id ='$user_fnd_iddd'");
