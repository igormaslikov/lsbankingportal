...
Thank you for submitting your application to MoneyLine. Unfortunately your application has been declined. If you have any questions regarding your application, contact us at support@pacificafinancegroup.com and a team member will respond shortly.";
...
//admin_leads_email_notification($subject_re,$message_re);

          // DB INSERTION STARTS
          
$query  = "INSERT INTO fnd_user_profile (first_name,last_name,email,mobile_number,address,city,state,zip_code,date_of_birth,creation_date,application_status,website,created_time_,loan_type,application_date)  VALUES ('$customer_fname','$customer_lname','$customer_email','$customer_tel','$address','$customer_city','$customer_state','$customer_zip','$dobb','$date','$app_status','$web_site','$time_created','$type_loan','$to_date_filter')";
