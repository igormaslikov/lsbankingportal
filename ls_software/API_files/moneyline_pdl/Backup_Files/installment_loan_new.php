...
//echo "select * from fnd_user_profile where email = '$customer_email' AND mobile_number = '$customer_tel'";
         $date_duplicate= date('Y-m-d', strtotime('-7 day'));
            ...
            $creation_date = $row_fnd_id['creation_date'];
...
$con->query("UPDATE fnd_user_profile SET application_status='New Application', creation_date='$to_date_filter', loan_type='$type_loan' where user_fnd_id ='$user_fnd_iddd'");
...
$query  = "INSERT INTO fnd_user_profile (first_name,last_name,email,mobile_number,address,city,state,zip_code,date_of_birth,creation_date,application_status,website,created_time_,loan_request_amount,payback_period,loan_type)  VALUES ('$customer_fname','$customer_lname','$customer_email','$customer_tel','$address','$customer_city','$customer_state','$customer_zip','$dobb','$date','$app_status','$web_site','$time_created','$amount','$payback','$type_loan')";
