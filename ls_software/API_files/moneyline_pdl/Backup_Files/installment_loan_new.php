...
mysqli_query($con, "UPDATE fnd_user_profile SET application_status='New Application', creation_date='$to_date_filter', loan_type='$type_loan' where user_fnd_id ='$user_fnd_iddd'");
