...
mail($email_denice,$subject_denice,$message_denice,$headers_denice);
 ...
 // MAIL TO Denice FOR FUNDED APPLICATIONS END 
    	...
    	echo '<meta http-equiv="Refresh" content="1; url=https://lspaydayloans.com/you-are-already-customer">';
...
if ($rowcount>0){
	...
	echo "record exists";
	echo '<meta http-equiv="Refresh" content="1; url=https://lspaydayloans.com/error">';
		//declined email
