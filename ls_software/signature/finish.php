...
$url_logo="https://ofsca.com/loanportal/ls_software/signature/"; 
...
$sql=mysqli_query($con, "select * from loan_initial_banking where email_key='$idd' "); 
...
$sql_loan=mysqli_query($con, "select * from tbl_loan where loan_id= '$loan_id' "); 
