...
$query = "select * from fnd_user_profile where website='mymoneyline_pdl' AND application_status='New Application' AND decision_logic_status!='1' AND (date_time_current<DATE_SUB(NOW(), INTERVAL 6 MINUTE ) AND date_time_current>DATE_SUB(NOW(), INTERVAL 24 HOUR))";
