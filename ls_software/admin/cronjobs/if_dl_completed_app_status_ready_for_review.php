...
$query = "SELECT * FROM fnd_user_profile WHERE date_time_current > DATEADD(MINUTE, -15, GETDATE())";
...
if ($decision_logic_status=='1')
{
         ...
         $con->query("UPDATE fnd_user_profile SET application_status='Ready for review'  where user_fnd_id = '$application_id'");
         ...
         $con->query("UPDATE fnd_user_profile SET application_status='Info Needed'  where user_fnd_id = '$application_id'");
         $date_update= date('Y-m-d H:i:s');
