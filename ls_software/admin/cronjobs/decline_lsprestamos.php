...
$user_fnd_id = $row_name['user_fnd_id'];
	 ...
	 $message = "Hola ".$customer_name." ".",Gracias por aplicar con Optima Financial Solutions Inc, lamentamos informarle que su aplicación ha sido declinada, usted no ha cumplido con los criterios correpondientes para extenderle un préstamo en estos momentos. Puede volver a aplicar después de 90 días.";
...
$con->query("UPDATE fnd_user_profile SET decision_logic_status ='1' where email = '$email'");
