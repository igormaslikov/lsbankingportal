...
$query = "select * from fnd_user_profile where website='lspaydayloans' AND application_status='New Application' AND decision_logic_status!='1' AND (date_time_current<DATEADD(MINUTE, -6, GETDATE()) AND date_time_current>DATEADD(HOUR, -24, GETDATE()))";
$sql=$con->query("$query"); 
