...
$query = "SELECT * FROM fnd_user_profile WHERE date_time_current < DATEADD(MINUTE, -10, GETDATE()) AND application_status = 'New Application'  AND decision_logic_status != '1' AND website = 'mymoneyline_cl'  AND experian_api_limit < 1 ORDER By user_fnd_id DESC OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY";
...
$quoteJson = json_decode($response);
 ...
 $score = str_replace(" ","",$score);
    ...
    $con->query($query_insert_activity);
	    ...
	    $phone12 = "+18187316919";
	    $message = " Credit Report Completed ".$first_name." ".$last_name;
