...
//$now = date('H');
 ...
 $sql_past_due=$con->query("select * from tbl_loan where loan_status= 'Collections' AND last_payment_date=''"); 
...
if($date>$payment_date_verification)
{
  ...
  $con->query("UPDATE tbl_loan SET loan_status = 'Chargeoff' where loan_create_id= '$loan_create_id'");
