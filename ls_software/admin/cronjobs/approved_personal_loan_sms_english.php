...
$query = "select * from fnd_user_profile where application_status = 'Approved Personal Loan' AND website='lsbanking_pl' AND (last_update_date BETWEEN '$last_date2' AND '$date') ";
...
$query_na = "select * from fnd_user_profile where application_status = 'Approved Personal Loan'  AND website='lsbanking_pl' AND (last_update_date BETWEEN '$last_date2_na' AND '$date_na') ";
