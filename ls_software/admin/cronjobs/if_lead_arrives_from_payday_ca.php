...
$query = "SELECT * FROM fnd_user_profile WHERE date_time_current < DATEADD(MINUTE, -12, GETDATE()) AND application_status = 'New Application' AND website='Payday CA'";
...
if ($decision_logic_status=='1')
{
         ...
         $con->query("UPDATE fnd_user_profile SET application_status='Review Payday CA'  where user_fnd_id = '$application_id'");
         ...
         $con->query("UPDATE fnd_user_profile SET application_status='DL/Bank Payday CA'  where user_fnd_id = '$application_id'");
         $date_update= date('Y-m-d H:i:s');
