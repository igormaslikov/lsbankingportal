...
$con->query("UPDATE fnd_user_profile SET application_status ='Approved Payday Loan' where email = '$email' AND application_status!='Declined' AND website = 'lsbanking_pdl'");
