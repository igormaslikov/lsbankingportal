...
$query = "select * from fnd_user_profile where application_status = 'Bank Information Needed' AND website='lsprestamos' AND (creation_date BETWEEN '$last_date2' AND '$date') ";
...
$query_na = "select * from fnd_user_profile where application_status = 'Bank Information Needed' AND website='lsprestamos' AND (creation_date BETWEEN '$last_date2_na' AND '$date_na') ";
