...
$sql_notes=$con->query("select * from tbl_loan_notes where loan_id='$iddd'"); 

while($row_notes = $sql_notes->fetch_array()) {
...
<div align="right">
<a href="add_new_charge_type.php?loan_id_charge=<?php echo $_GET['id']; ?>"> <button name="btn-submit" type="submit" class="btn btn-danger" style="color: #fff;background-color: #1E90FF;border-color: #1E90FF;margin-right:10%;margin-top:-6%;background-image: linear-gradient(to bottom,#1E90FF 0,#1E90FF 100%);">Add New Charge</button></a>
...
<th style='width:100px;'>Charge Date</th>
<th style='width:50px;'>Charge Type</th>
<th style='width:50px;'>Application Type</th>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = $con->query("SELECT * FROM tbl_charge_type where loan_id='$id'");
...
$con->query("UPDATE tbl_loan SET  primary_portfolio='$p_portfolio_update' , amount_of_loan='$amount_loan_update' , loan_total_payable='$amount_left_update' , next_payment_date='$next_payment_date_update', payment_tenure='$p_tenure_update', last_update_by='$uu_id',last_update_date='$date' where loan_id ='$id'"); 

$con->query("UPDATE tbl_loan_type SET loan_type ='$loan_type_update' ,  last_update_by='$uu_id',last_update_date='$date' where loan_type_id ='$id_type'"); 
...
$con->query("UPDATE tbl_loan_classification SET loan_classification ='$loan_calssifi_update' ,  last_update_by='$uu_id',last_update_date='$date' where loan_clasi_id ='$id_clasi'"); 
