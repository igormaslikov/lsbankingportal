...
$message_admin = 'https://pacificafinancegroup.com/loanportal/signature_customer/completed/index.php?id='.$email_key;
...
$to_email = $email;
$subject = 'Contract';
$message = 'https://pacificafinancegroup.com/loanportal/signature_customer/files/contract.php?id='.$email_key;
$message_email = 'https://pacificafinancegroup.com/loanportal/signature_customer/completed/index.php?id='.$email_key;
...
$sql_fetch_loan=mysqli_query($con, "select * from tbl_loan where user_fnd_id= '$fnd_idd'"); 
...
$query  = "INSERT INTO tbl_loan (user_fnd_id,bg_id,amount_of_loan,secured_loan,contract_date,payment_date,creation_date,created_by,loan_create_id,loan_fee,loan_total_payable,loan_status,secondary_portfolio)  VALUES ('$fnd_idd','$source','$amount_loan','$secure_loan','$contract_date','$payment_date','$date','$u_id','$loan_create_id','$loan_fee','$payoff_amount','Active','None')";
        ...
        echo "<h3> Error Inserting Data </h3>";
         ...
         $query_in  = "INSERT INTO loan_initial_banking (loan_id,user_fnd_id,creation_date,update_date,created_by,email_key,sign_status,update_by)  VALUES ('$loan_id','$fndd_id','$date','$date','$u_id','$email_key','0','$u_id')";
...
window.location.href = 'renew_customer_email_message.php?emaill=<?php echo $email; ?>&link=<?php echo $message;?>&email_link=<?php echo $message_email;?>';
</script>
