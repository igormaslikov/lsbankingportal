...
<img src="https://ofsca.com/loanportal/ls_software/website/images/Money-Line-Logo.JPG"> <hr><br>
<?php 
$id=$_GET['id'];
   include 'dbconnect.php';
   include 'dbconfig.php';
...
?>
<!--
<iframe src="https://ofsca.com/loanportal/signature_customer/credit_report/credit_report.php?id=<?php echo $id;?>"  width="100%" height="800"></iframe>
-->
</body>
</html>