...
<div class="col-lg-4"><p> Application ID :<b style="color:red"> <?php echo $id;?></b></p></div>
<div class="col-lg-4"><p> Customer Name:<b style="color:red"> <?php echo $first_name;?></b></p></div>
<div class="col-lg-4"><p> Creation Date:<b style="color:red"> <?php echo $creationdate;?> </b></p></div>
<div class="col-lg-4"><p>Last Update By: <b style="color:red"><?php echo $name_update;?> </b></p></div>
<div class="col-lg-4"><p> Last Update Date: <b style="color:red"> <?php echo $last_updatedate;?></b></p></div>
...
<hr>
  ...
  <form action ="#" method="POST">
    ...
    <div class = "row">
      ...
      <div class="col-lg-9"><h3 style="color:red;">Personal  Information  <?php 
if($credit_score>10) { echo "<span style='float:right;'> (Score - ". ltrim($credit_score, '0'). ") </span>"; } ?>   </h3></div>
	

	<div class="col-lg-3"> <br><b style="font-size: 20px;"><?php if($decision_logic_status == 1) {echo '<span class="glyphicon glyphicon-ok-circle" aria-hidden="true" alt="Verified"></span>  <span style = "color:green; text-align:left">Decision Logic Verified</span>';} ?></b></div>
	</div>
    <div class="row">
...
<select name="app_status" id="app_status" class="form-control">
    <option></option>
<option value="All Application" <?php if($appli_status=='All Application'){ echo 'selected';} ?>>All Application</option>
<option value="New Application" <?php if($appli_status=='New Application'){ echo 'selected';} ?>>New Application</option>
<option value="Declined"<?php if($appli_status=='Declined'){ echo 'selected';}?>>Declined</option>
<option value="Funded"<?php if($appli_status=='Funded'){ echo 'selected';}?>>Funded</option>
<option value="No Answer"<?php if($appli_status=='No Answer'){ echo 'selected';}?>>No Answer</option>
<option value="Rejected By Customer"<?php if($appli_status=='Rejected By Customer'){ echo 'selected';}?>>Rejected By Customer</option>
<option value="Approved Payday CA"<?php if($appli_status=='Approved Payday CA'){ echo 'selected';}?>>Approved Payday CA</option>
<option value="Approved Payday NV"<?php if($appli_status=='Approved Payday NV'){ echo 'selected';}?>>Approved Payday NV</option>
<option value="Approved Payday IL"<?php if($appli_status=='Approved Payday IL'){ echo 'selected';}?>>Approved Payday IL</option>
<option value="Approved Installment CA"<?php if($appli_status=='Approved Installment CA'){ echo 'selected';}?>>Approved Installment CA</option>
<option value="Approved Installment AZ"<?php if($appli_status=='Approved Installment AZ'){ echo 'selected';}?>>Approved Installment AZ</option>
<option value="Approved Installment NV"<?php if($appli_status=='Approved Installment NV'){ echo 'selected';}?>>Approved Installment NV</option>
<option value="Review Payday CA"<?php if($appli_status=='Review Payday CA'){ echo 'selected';}?>>Review Payday CA</option>
<option value="Review Payday NV"<?php if($appli_status=='Review Payday NV'){ echo 'selected';}?>>Review Payday NV</option>
<option value="Review Payday IL"<?php if($appli_status=='Review Payday IL'){ echo 'selected';}?>>Review Payday IL</option>
<option value="Review Installment CA"<?php if($appli_status=='Review Installment CA'){ echo 'selected';}?>>Review Installment CA</option>
<option value="Review Installment AZ"<?php if($appli_status=='Review Installment AZ'){ echo 'selected';}?>>Review Installment AZ</option>
<option value="Review Installment NV"<?php if($appli_status=='Review Installment NV'){ echo 'selected';}?>>Review Installment NV</option>
<option value="DL/Bank Payday CA"<?php if($appli_status=='DL/Bank Payday CA'){ echo 'selected';}?>>DL/Bank Payday CA</option>
<option value="DL/Bank Payday NV"<?php if($appli_status=='DL/Bank Payday NV'){ echo 'selected';}?>>DL/Bank Payday NV</option>
<option value="DL/Bank Payday IL"<?php if($appli_status=='DL/Bank Payday IL'){ echo 'selected';}?>>DL/Bank Payday IL</option>
<option value="DL/Bank Installment CA"<?php if($appli_status=='DL/Bank Installment CA'){ echo 'selected';}?>>DL/Bank Installment CA</option>
<option value="DL/Bank Installment AZ"<?php if($appli_status=='DL/Bank Installment AZ'){ echo 'selected';}?>>DL/Bank Installment AZ</option>
<option value="DL/Bank Installment NV"<?php if($appli_status=='DL/Bank Installment NV'){ echo 'selected';}?>>DL/Bank Installment NV</option>



<!--<option value="New Application" <?php if($appli_status=='New Application'){ echo 'selected';} ?>>New Application</option>-->
<!--<option value="Ready for review"<?php if($appli_status=='Ready for review'){ echo 'selected';}?>>Ready for review</option>-->
<!--<option value="Info Needed"<?php if($appli_status=='Info Needed'){ echo 'selected';}?>>Info Needed</option>-->
<!--<option value="Approved Payday NV"<?php if($appli_status=='Approved Payday NV'){ echo 'selected';}?>>Approved Payday NV</option>-->
<!--<option value="Approved Commercial CA"<?php if($appli_status=='Approved Commercial CA'){ echo 'selected';}?>>Approved Commercial CA</option>-->
<!--<option value="DL/Bank Needed"<?php if($appli_status=='DL/Bank Needed'){ echo 'selected';}?>>DL/Bank Needed</option>-->
<!--<option value="Review Payday NV"<?php if($appli_status=='Review Payday NV'){ echo 'selected';}?>>Review Payday NV</option>-->
<!--<option value="Review Commercial CA"<?php if($appli_status=='Review Commercial CA'){ echo 'selected';}?>>Review Commercial CA</option>-->
<!--<option value="Credit Report Completed" <?php if($appli_status=='Credit Report Completed'){ echo 'selected';} ?>>Credit Report Completed</option>-->
<!--<option value="Decision Logic Completed" <?php if($appli_status=='Decision Logic Completed'){ echo 'selected';} ?>>Decision Logic Completed</option>-->
<!--<option value="Credit Report Needed" <?php if($appli_status=='Credit Report Needed'){ echo 'selected';} ?>>Credit Report Needed</option>-->
<!--<option value="Bank Information Needed" <?php if($appli_status=='Bank Information Needed'){ echo 'selected';} ?>>Bank Information Needed</option>-->
<!--<option value="Final Review For Personal Loan" <?php if($appli_status=='Final Review For Personal Loan'){ echo 'selected';} ?>>Final Review For Personal Loan</option>-->
<!--<option value="No Decision Logic For Payday" <?php if($appli_status=='No Decision Logic For Payday'){ echo 'selected';} ?>>No Decision Logic For Payday</option>-->
<!--<option value="Review For Payday" <?php if($appli_status=='Review For Payday'){ echo 'selected';} ?>>Review For Payday</option>-->
<!--<option value="Approved Payday Loan" <?php if($appli_status=='Approved Payday Loan'){ echo 'selected';} ?>>Approved Payday Loan</option>-->
<!--<option value="Approved Personal Loan" <?php if($appli_status=='Approved Personal Loan'){ echo 'selected';} ?>>Approved Personal Loan</option>-->
<!--<option value="Approved Title Loan" <?php if($appli_status=='Approved Title Loan'){ echo 'selected';} ?>>Approved Title Loan</option>-->
<!--<option value="Interview Completed" <?php if($appli_status=='Interview Completed'){ echo 'selected';} ?>>Interview Completed</option>-->
<!--<option value="Pending Documents" <?php if($appli_status=='Pending Documents'){ echo 'selected';} ?>>Pending Documents</option>-->
</select>
    </div>
...
<select name="amount_loan" id="amount_loan" class="form-control">
    <option></option>
<option value="Needs Review" <?php if($loan_amount=='Needs Review'){ echo 'selected';} ?>>Needs Review</option>
<option value="25" <?php if($loan_amount=='25'){ echo 'selected';} ?>>25</option>
<option value="50" <?php if($loan_amount=='50'){ echo 'selected';} ?>>50</option>
<option value="75" <?php if($loan_amount=='75'){ echo 'selected';} ?>>75</option>
<option value="100" <?php if($loan_amount=='100'){ echo 'selected';} ?>>100</option>
<option value="125" <?php if($loan_amount=='125'){ echo 'selected';} ?>>125</option>
<option value="150" <?php if($loan_amount=='150'){ echo 'selected';} ?>>150</option>
<option value="175" <?php if($loan_amount=='175'){ echo 'selected';} ?>>175</option>
<option value="200" <?php if($loan_amount=='200'){ echo 'selected';} ?>>200</option>
<option value="225" <?php if($loan_amount=='225'){ echo 'selected';} ?>>225</option>
<option value="250" <?php if($loan_amount=='250'){ echo 'selected';} ?>>250</option>
<option value="255" <?php if($loan_amount=='255'){ echo 'selected';} ?>>255</option>
</select>
    </div>
...
<select name="source_of_lead" id="source_of_lead" class="form-control">
    <option></option>
<option value="Facebook" <?php if($source_lead=='Facebook'){ echo 'selected';} ?>>Facebook</option>
<option value="Google" <?php if($source_lead=='Google'){ echo 'selected';} ?>>Google</option>
<option value="Instagram" <?php if($source_lead=='Instagram'){ echo 'selected';} ?>>Instagram</option>
<option value="Banner" <?php if($source_lead=='Banner'){ echo 'selected';} ?>>Banner</option>
<option value="Radio" <?php if($source_lead=='Radio'){ echo 'selected';} ?>>Radio</option>
<option value="Referred by Customer" <?php if($source_lead=='Referred by Customer'){ echo 'selected';} ?>>Referred by Customer</option>
<option value="Repeat Customer" <?php if($source_lead=='Repeat Customer'){ echo 'selected';} ?>>Repeat Customer</option>
</select>
    </div>
...
<option value="No Credit" <?php if($declined_reason=='No Credit'){ echo 'selected';} ?>>No Credit</option>
<option value="Low Credit"<?php if($declined_reason=='Low Credit'){ echo 'selected';}?>>Low Credit</option>
<option value="New Credit"<?php if($declined_reason=='New Credit'){ echo 'selected';}?>>New Credit</option>
<option value="Bad Credit" <?php if($declined_reason=='Bad Credit'){ echo 'selected';} ?>>Bad Credit</option>
<option value="Too Many Loans" <?php if($declined_reason=='Too Many Loans'){ echo 'selected';} ?>>Too Many Loans</option>
<option value="Too Many NSF Fees" <?php if($declined_reason=='Too Many NSF Fees'){ echo 'selected';} ?>>Too Many NSF Fees</option>
<option value="No Bank Account"<?php if($declined_reason=='No Bank Account'){ echo 'selected';}?>>No Bank Account</option>
<option value="New Bank Account"<?php if($declined_reason=='New Bank Account'){ echo 'selected';}?>>New Bank Account</option>
<option value="Low Income"<?php if($declined_reason=='Low Income'){ echo 'selected';}?>>Low Income</option>
<option value="Unemployed/Retired/SSI"<?php if($declined_reason=='Unemployed/Retired/SSI'){ echo 'selected';}?>>Unemployed/Retired/SSI</option>
<option value="Chargeoff Loans"<?php if($declined_reason=='Chargeoff Loans'){ echo 'selected';}?>>Chargeoff Loans</option>
<option value="Bankruptcy"<?php if($declined_reason=='Bankruptcy'){ echo 'selected';}?>>Bankruptcy</option>
<option value="SMS Blocked"<?php if($declined_reason=='SMS Blocked'){ echo 'selected';}?>>SMS Blocked</option>
<option value="Repeat Application" <?php if($declined_reason=='Repeat Application'){ echo 'selected';} ?>>Repeat Application</option>
<option value="Declined by Customer" <?php if($declined_reason=='Declined by Customer'){ echo 'selected';} ?>>Declined by Customer</option>
<option value="Incomplete Paperwork" <?php if($declined_reason=='Incomplete Paperwork'){ echo 'selected';} ?>>Incomplete Paperwork</option>
<option value="No Answer" <?php if($declined_reason=='No Answer'){ echo 'selected';} ?>>No Answer</option>
<option value="Low Vehicle Value" <?php if($declined_reason=='Low Vehicle Value'){ echo 'selected';} ?>>Low Vehicle Value</option>
<option value="Account Overdraft" <?php if($declined_reason=='Account Overdraft'){ echo 'selected';} ?>>Account Overdraft</option>
</select>
    </div>    
...
<select name="personal_loan" id="personal_loan" class="form-control">
    <option></option>
<option value="Needs Review" <?php if($personal_loan_term=='Needs Review'){ echo 'selected';} ?>>Needs Review</option>
<option value="5005.00" <?php if($personal_loan_term=='5005.00'){ echo 'selected';} ?>>5005.00</option>
<option value="6005.00" <?php if($personal_loan_term=='6005.00'){ echo 'selected';} ?>>6005.00</option>
<option value="7005.00" <?php if($personal_loan_term=='7005.00'){ echo 'selected';} ?>>7005.00</option>
<option value="8005.00" <?php if($personal_loan_term=='8005.00'){ echo 'selected';} ?>>8005.00</option>
</select>
    </div>
...
<select name="payback_period" id="payback_period" class="form-control">
    <option></option>
<option value="1-3 Months" <?php if($payback_period=='1-3 Months'){ echo 'selected';} ?>>1-3 Months</option>
<option value="3-6 Months" <?php if($payback_period=='3-6 Months'){ echo 'selected';} ?>>3-6 Months</option>
<option value="6-12 Months" <?php if($payback_period=='6-12 Months'){ echo 'selected';} ?>>6-12 Months</option>
<option value="1-2 Years" <?php if($payback_period=='1-2 Years'){ echo 'selected';} ?>>1-2 Years</option>
</select>
    </div>
...
<a href="customer_all_loans.php?id=<?php echo $cu_id ;?>" <button name="newloan" type="submit" class="btn btn-danger" style="background-image: linear-gradient(to bottom,#95c500 0,#639a0a 100%);
    ...
    <br>
	   ...
	   <div class="row">
			<div class="col-lg-4"><h4>ID PHOTO :</h4><?php if($id_photo!="") { ?><a href="../dl_client_files/photo_id/<?php echo $id_photo;?>" target="_blank"><img style="width:95%" src="../dl_client_files/photo_id/<?php echo $id_photo; ?>"/> <?php } ?></a></div>
<div class="col-lg-4"><h4>BANK CARD FRONT :</h4><?php if($bank_front!="") { ?><a href="../dl_client_files/bank_front_image/<?php echo $bank_front;?>" target="_blank"><img style="width:95%" src="../dl_client_files/bank_front_image/<?php echo $bank_front; ?>"/><?php } ?></a></div>
			<div class="col-lg-4"><h4>BANK CARD BACK :</h4><?php if($bank_back!="") { ?><a href="../dl_client_files/bank_back_image/<?php echo $bank_back;?>" target="_blank"><img  style="width:95%" src="../dl_client_files/bank_back_image/<?php echo $bank_back; ?>"/><?php } ?></a></div>
			
			<div class="col-lg-4"><h4>Void Check/Account Number Screenshot :</h4><?php if($void_img!="") { ?><a href="../dl_client_files/void_img/<?php echo $void_img;?>" target="_blank"><img  style="width:95%" src="../dl_client_files/void_img/<?php  echo $void_img; ?>"/><?php } ?></a></div>
	   </div>
...
echo '<br><table style="width:100%;padding:10px" class="table table-striped table-bordered">'."
<tr>
<th>Details Of Credit Report - </th><th>" ; if ($loan_type=='commercial') { echo ' - <a style="color:red; text-align:right" href="credit_report.php?id='.$id.'" target="_blank"><b  alt="Regenrate Credit Report">Run New Experian Credit Report
</b></a>';} echo'</th>
</tr>';
