              ...
              <div class="row">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    $sql_loan = $con->query("select * from loan_initial_banking where user_fnd_id = '$id'");
...
<a href='loan/add_secondary_card.php?bank_id=$initial_id&fnd_id=$id&id=$loan_id' title='Edit This User'>Add Another Card</a> - <a href='loan/view_all_card_info.php?bank_id=$initial_id&fnd_id=$id&id=$loan_id' title='Edit This User'>View All Cards</a>
 ...
 <input type="text" name="apr"  class="form-control" id="usr" value="' . $apr . '">
              ...
              $result_status = $con->query("SELECT * FROM application_status_updates where application_id = '$id' ORDER BY id DESC OFFSET 0 ROWS FETCH NEXT 30 ROWS ONLY");
...
<th>User</th>
              ...
              while ($result_status && ($row_status = $result_status->fetch_array())) {
                ...
                while ($sql_activity_by_user && ($row_sql_activity_by_user = $sql_activity_by_user->fetch_array())) {
...
<br><br>";
    ...
    CURLOPT_SSL_VERIFYHOST => false,
          ...
          $DL_available_overdraft = $DL_available_balance = $DL_totalamount = $DL_totalamount_loan = '';
          $DL_as_date = $DL_current_balance = $DL_average_balance = '';
          $DL_deposits_credit = $DL_avg_balance_last_month = $DL_withdrawals = '';
...
has been approved " . $phone_number_update . " and loan term is " . $personal_loan . ". ";
    ...
    //$con->query("INSERT INTO application_status_updates( application_id, user_id, status, creation_date) VALUES ('$id','$u_id','$app_status_update','$date')");
