...
$query_main_search = "SELECT * FROM `fnd_user_profile` WHERE `bold_status` = '0' ORDER BY user_fnd_id DESC   ";
...
<strong style="display:none">Page <?php echo $page_no." of ".$total_no_of_pages; ?></strong>
</div>
