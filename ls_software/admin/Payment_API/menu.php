...
<nav class="navbar navbar-default navbar-fixed-top" style="background-image: linear-gradient(to bottom,#1E90FF 0,#1E90FF 100%);">
  ...
  <!--      <li class="user"><a href="https://ofsca.com/loanportal/ls_software/admin/calculator/payday_loan.php"  style="color:white;">Calculator</a></li>-->
  <!--      <li class="user"><a href="https://ofsca.com/loanportal/ls_software/admin/view_all_credit_reports.php"  style="color:white;">View All Credit Reports</a></li>-->
