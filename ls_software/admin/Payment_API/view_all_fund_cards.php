...
<th style='width:33%;color:black;'>Customer Id</th>
<th style='width:33%;color:black;'>Amount</th>
<th style='width:34%;color:black;'>Url to Use</th>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = $con->query("SELECT COUNT(*) As total_records FROM tbl_fund_card ORDER BY id DESC");
	$total_records = $result_count->fetch_array();
	$total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
	$second_last = $total_no_of_pages - 1; // total page minus 1

    $result = $con->query("SELECT * FROM tbl_fund_card ORDER BY id DESC OFFSET $offset ROWS FETCH NEXT $total_records_per_page ROWS ONLY");
