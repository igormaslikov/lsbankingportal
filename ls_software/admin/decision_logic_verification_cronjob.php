...
Please Follow the link (https://pacificafinancegroup.com/loanportal/ls_software/dl_client_files/index.php?email='.$email.'&code='.$code.') to submit your documents (Photo ID, Bank Card Front/Back) to LS BANKING';
$headers = 'From: info@lspaydayloans.com';
mail($to_email,$subject,$message,$headers);
