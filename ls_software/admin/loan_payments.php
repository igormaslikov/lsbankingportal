...
$con->query("UPDATE tbl_loan SET  primary_portfolio='$p_portfolio_update' , amount_of_loan='$amount_loan_update' , amount_left='$amount_left_update' , next_payment_date='$next_payment_date_update', payment_tenure='$p_tenure_update', last_update_by='$uu_id',last_update_date='$date' where loan_id ='$id'"); 
