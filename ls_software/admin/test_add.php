...
<div class="col-lg-4"><p> Last Update Date: <b style="color:red"> <?php echo $id;?></b></p></div>
...
<input name ="user_id" style="display:none" value=" <?php echo $user_id ?>">
      <button name="btn-submit" type="submit" class="btn btn-danger" style="background-image: linear-gradient(to bottom,#1E90FF 0,#1E90FF 100%);color: #fff;background-color: #1E90FF;border-color: #1E90FF;">Submit</button>
  </div>
    </div>
