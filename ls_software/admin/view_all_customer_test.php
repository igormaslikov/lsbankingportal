...
<form action="view_all_customer_duplicate.php" method="GET">
...
<option value="payday loan"<?php if($_GET['loan_type']=='payday loan'){ echo 'selected';}?>>payday loan</option>
<option value="personal loan"<?php if($_GET['loan_type']=='personal loan'){ echo 'selected';}?>>personal loan</option>
</select>
</td>
...
<table class="table table-striped table-bordered"  style="font-size:16px !important">
   ...
   <span style="font-size:13px";  aria-hidden="true" alt="edit">
       ...
       echo "
   -<a href='view_all_customer_duplicate.php?status=".$_GET['status']."&website=".$_GET['website']."&state=".$_GET['state']."&loan_type=".$_GET['loan_type']."&keyword=".$_GET['keyword']."&from_date=$from_date_filter&to_date=$to_date_filter&search='>  Today  </a> ";
   ?>
   </span>  
   ...
   <span style="font-size:13px";  aria-hidden="true" alt="edit">
       ...
       echo
       "
       -<a href='view_all_customer_duplicate.php?status=".$_GET['status']."&website=".$_GET['website']."&state=".$_GET['state']."&loan_type=".$_GET['loan_type']."&keyword=".$_GET['keyword']."&from_date=$from_date_filter&to_date=$to_date_filter&search='>  Yesterday </a> ";
       ...
       <span style="font-size:13px";  aria-hidden="true" alt="edit">
           ...
           echo "
       -<a href='view_all_customer_duplicate.php?status=".$_GET['status']."&website=".$_GET['website']."&state=".$_GET['state']."&loan_type=".$_GET['loan_type']."&keyword=".$_GET['keyword']."&from_date=$from_date_filter&to_date=$to_date_filter&search='> Last 3 Days </a> ";
       ?>
       </span>
       ...
       <span style="font-size:13px";  aria-hidden="true" alt="edit">
           ...
           //echo" ". $to_date;
           echo "
       -<a href='view_all_customer_duplicate.php?status=".$_GET['status']."&website=".$_GET['website']."&state=".$_GET['state']."&loan_type=".$_GET['loan_type']."&keyword=".$_GET['keyword']."&from_date=$from_date_filter&to_date=$to_date_filter&search='>  Last 7 Days  </a> ";  
       ?>
       </span>
       ...
       $from_date_filter= date('Y-m-d', strtotime('first day of this month'));  //echo" ". $to_date;
          echo " 
       -<a href='view_all_customer_duplicate.php?status=".$_GET['status']."&website=".$_GET['website']."&state=".$_GET['state']."&loan_type=".$_GET['loan_type']."&keyword=".$_GET['keyword']."&from_date=$from_date_filter&to_date=$to_date_filter&search='> This Month </a>"; 
       ?>
       </span>
       ...
       <span style="font-size:13px";  aria-hidden="true" alt="edit">
           ...
           echo"
       -<a href='view_all_customer_duplicate.php?status=".$_GET['status']."&website=".$_GET['website']."&state=".$_GET['state']."&loan_type=".$_GET['loan_type']."&keyword=".$_GET['keyword']."&from_date=$from_date_filter&to_date=$to_date_filter&search='> This Year  </a> ";
       ?>
...
<th style='width:100px;color:black;'>Application Date</th>
<th style='width:100px;color:black;'>First Name</th>
<th style='width:100px;color:black;'>Last Name</th>
<th style='width:100px;color:black;'>Phone #</th>
<th style='width:100px;color:black;'>State</th>
<th style='width:100px;color:black;'>App Type</th>
  <th style='width:30px;color:black;'>Website</th>
<th style='width:30px;color:black;'>Application Status</th>
