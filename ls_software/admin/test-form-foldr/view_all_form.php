    ...
    while($row = mysqli_fetch_array($result)){
		...
		echo "<tr>
			  ...
			  <td>".$row['form_name']."</td>
		   	    ...
		   	    <a class='' href='edit_form.php?id=$id' title='Edit This User'><span class='glyphicon glyphicon-edit' aria-hidden='true' alt='edit'></span></a>

<a class='' href='delete_form.php?id=$id' title='Delete This User'><span class='glyphicon glyphicon-remove' aria-hidden='true' alt='delete'></span></a>
...
<script type="text/javascript">
    $('.remove-box').on('click', function () {
      var x =  confirm('You are not authorize to do that opration');
      if (x)
      return true;
  else
    return false;
