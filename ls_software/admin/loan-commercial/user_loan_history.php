    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        for($x = 0; $x < $arrlength; $x++) {  
            ...
            echo "<div><a target='_blank' href='https://www.pacificafinancegroup.com/loanportal/signature_commercial_loan/files/sign_contract.php?id=$email_keys[$x]'><span class='glyphicon glyphicon-file' title='Contract' aria-hidden='true' alt='Contract'></span></a></div></div>";
          }
