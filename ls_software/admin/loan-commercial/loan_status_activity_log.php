...
while ($row_payment=$query_payment->fetch_array()){
 ...
 $sql_loan_settings=$con->query("select * from tbl_loan_setting where loan_amount= '$amount_loan'"); 
...
$result_status = $con->query("SELECT * FROM application_status_updates where loan_create_id = '$loan_create_id' order by id desc ");
...
$result_statuss = $con->query("SELECT * FROM commercial_loan_transaction where loan_create_id = '$loan_create_id'");
...
$counter="1";
while($row_statuss = $result_statuss->fetch_array())

{
$created_by_get_db_activityy = $row_statuss['user_id'];
$sql_activity_by_userr=$con->query("select * from tbl_users where user_id= '$created_by_get_db_activityy'"); 
$final_activity_by_userr = '';
while($row_sql_activity_by_userr = $sql_activity_by_userr->fetch_array()) {
