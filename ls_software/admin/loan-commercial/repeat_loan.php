...
$query_search = "SELECT * FROM tbl_commercial_loan where user_fnd_id= '$user_fnd_id'";
...
if ($result_t=$con->query($query_search))
 ...
 // echo $rowcount;
   ...
   $sql_dup = "SELECT * FROM tbl_repeat_loan WHERE user_fnd_id = '$user_fnd_id'";
       ...
       {
           $con->query("UPDATE tbl_repeat_loan SET  loan_count='$rowcount'  where user_fnd_id ='$user_fnd_id'");
     }
       else
       {  
...
<?php
$query_loan= "SELECT * FROM tbl_commercial_loan";
