...
$sql_bank_detail=mysqli_query($con, "select * from commercial_loan_initial_banking where per_initial_id = '$bank_id'"); 
    ...
    if ($update_allowed==1)
{
      ...
      mysqli_query($con, "UPDATE commercial_loan_initial_banking SET type_of_card='$type_card_up', card_number='$card_number_up', card_exp_date='$card_exp_date_up', bank_name='$bank_name_up', routing_number='$routing_number_up', account_number='$account_number_up', cvv_number='$cvv_number_up' where per_initial_id='$bank_id' ");
