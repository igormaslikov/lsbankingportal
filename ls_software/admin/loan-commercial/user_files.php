...
$address_contarct="https://ofsca.com/loanportal/signature_commercial_loan";
...
$sql_mail_key=mysqli_query($con, "select * from commercial_loan_initial_banking where user_fnd_id = '$user_fnd_id'"); 
...
if($void_img == ''){
    ...
    ';
        ...
        {
        echo "<a onclick='myFunction_contract_manual()' target = '_blank' class='remove-box' href='https://ofsca.com/loanportal/ls_software/admin/loan-commercial/uploads_contract/$contract_db?id=$id' target='_blank' title='View Contract'>View Echeck Contract</a>";
        }
        else{
