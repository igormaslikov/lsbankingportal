...
$address_contarct="https://lsbankingportal.com/signature_commercial_loan";
...
if($void_img == ''){
    ...
    ';
        ...
        {
        echo "<a onclick='myFunction_contract_manual()' target = '_blank' class='remove-box' href='https://lsbankingportal.com/ls_software/admin/loan-commercial/uploads_contract/$contract_db?id=$id' target='_blank' title='View Contract'>View Echeck Contract</a>";
        }
        else{
