     ...
     if(isset($_POST['btn-submit'])) 
{
     ...
     $notes= $_POST['loan_notes'];
      ...
      $con->query("UPDATE tbl_commercial_loan SET amount_of_loan ='$amount_loan_up', loan_total_payable ='$amount_left_up', payment_date ='$next_payment_date_up' where user_fnd_id ='$user_fnd_id'");
