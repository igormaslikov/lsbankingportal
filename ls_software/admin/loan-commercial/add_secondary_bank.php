     ...
     if(isset($_POST['btn-submit'])) 
{
    ...
    $card_exp_date = $expiry_year_card. "/".$expiry_month_card;
     ...
     $query_in  = "INSERT INTO commercial_loan_initial_banking (loan_id,user_fnd_id,type_of_card,card_number,card_exp_date,bank_name,routing_number,account_number,cvv_number,creation_date,created_by)  VALUES ('$loan_create_id','$user_fnd_id','$type_card','$card_number','$card_exp_date','$bank_name','$routing_number','$account_number','$cvv_number','$date','$u_id')";
