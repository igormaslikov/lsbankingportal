...
$sql_install=mysqli_query($con, "select * from tbl_commercial_loan_installments where id='$installment_id'"); 
...

{
    ...
    mysqli_query($con, "UPDATE commercial_loan_transaction SET interest='$interest_amount_up', principal_amount='$principal_amount_up', remaining_balance='$balance_amount', late_fee='$late_fee', payment_date='$payment_date_up' where id='$transaction_id'");

     

    mysqli_query($con, "UPDATE tbl_commercial_loan_installments SET payment_description='$payment_description_up' where id='$installment_id_up'");
