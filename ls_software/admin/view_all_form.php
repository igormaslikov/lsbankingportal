...
<div align="right">
<a href="add_form.php"> <button name="btn-submit" type="submit" class="btn btn-danger" style="background-color: #1E90FF;color: white;border-color: #1E90FF;">Add New Form</button></a>

<h4  style="float:left;"> Total Forms: <?php echo $rowcount;?>  </h4>
...
<th style='width:100px;color:black;'>Form Description</th>
<th style='width:100px;color:black;'>Form Name</th>
    ...
    while($row = mysqli_fetch_array($result)){
		...
		echo "<tr>
			  ...
			  <td>".$row['form_name']."</td>
		   	    ...
		   	    <td><a href='edit_form.php?id=$id' title='Edit This User'><span class='glyphicon glyphicon-edit' aria-hidden='true' alt='edit'></span></a>

<a class='remove-box' href='delete_form.php?id=$id' title='Delete This User'><span class='glyphicon glyphicon-remove' aria-hidden='true' alt='delete'></span></a>
