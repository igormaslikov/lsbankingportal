...
<!--<div class="col-lg-4"><p style="color:black;font-weight: bold">Total Applications: <b style="color:red"> <?php //echo $rowcount_customer;?> </b></p></div>-->
<!--<div class="col-lg-4"><p style="color:black;font-weight: bold">Initial Review:<b style="color:red"> <?php //echo $rowcount_user;?></b></p></div>-->
<!--<div class="col-lg-4"><p style="color:black;font-weight: bold">Final Review: <b style="color:red"> <?php //echo $rowcount_company;?> </b> </p></div>-->
...
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Payday+CA&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Payday CA :<b style="color:red"> <?php echo $rowcount_dl_bank_ca;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Approved+Payday+NV&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Approved Payday NV :<b style="color:red"> <?php echo $rowcount_aprovd_paydy_nv;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Review+Payday+NV&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Review Payday NV :<b style="color:red"> <?php echo $rowcount_rev_payday_nv;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Payday+NV&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Payday NV :<b style="color:red"> <?php echo $rowcount_dl_bank_nv;?></b></a></p></div>

<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Approved+Payday+IL&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Approved Payday IL :<b style="color:red"> <?php echo $rowcount_aprovd_paydy_il;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Review+Payday+IL&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Review Payday IL :<b style="color:red"> <?php echo $rowcount_rev_payday_il;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Payday+IL&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Payday IL :<b style="color:red"> <?php echo $rowcount_dl_bank_il;?></b></a></p></div>

<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Approved+Installment+CA&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Approved Commercial CA :<b style="color:red"> <?php echo $rowcount_aprovd_intall_ca;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Review+Installment+CA&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Review Commercial CA :<b style="color:red"> <?php echo $rowcount_rev_ca;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Installment+CA&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Commercial CA :<b style="color:red"> <?php echo $rowcount_dl_bank_install_ca;?></b></a></p></div>


<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Approved+Installment+AZ&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Approved Installment AZ :<b style="color:red"> <?php echo $rowcount_install_paydy_az;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Review+Installment+AZ&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Review Installment AZ :<b style="color:red"> <?php echo $rowcount_rev_install_az;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Installment+AZ&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Installment AZ :<b style="color:red"> <?php echo $rowcount_dl_bank_install_az;?></b></a></p></div>

<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Approved+Installment+IL&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Approved Installment IL :<b style="color:red"> <?php echo $rowcount_aprovd_install_il;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Review+Installment+IL&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Review Installment IL :<b style="color:red"> <?php echo $rowcount_rev_install_il;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Installment+IL&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Installment IL :<b style="color:red"> <?php echo $rowcount_dl_bank_install_il;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Approved+Installment+NV&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Approved Installment NV :<b style="color:red"> <?php echo $rowcount_install_paydy_nv;?></b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Review+Installment+NV&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">Review Installment NV : <b style="color:red"> <?php echo $rowcount_rev_install_nv;?> </b></a></p></div>
<div class="col-lg-4"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=DL/Bank+Installment+NV&website=All&state=All&loan_type=All&keyword=&from_date=&to_date=&search=">DL/Bank Installment NV : <b style="color:red"> <?php echo $rowcount_dl_bank_install_nv;?> </b></a></p></div>
...
<!--<div class="col-lg-3"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Decision+Logic+Completed&website=All&keyword=&from_date=&to_date=&search=">Decision Logic Completed :<b style="color:red"> <?php //echo $rowcount_dl_completed;?></b></a></p></div>-->
<!--<div class="col-lg-3"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Credit+Report+Completed&website=All&keyword=&from_date=&to_date=&search=">Credit Report Completed : <b style="color:red"> <?php //echo $rowcount_cr_completed;?> </b></a></p></div>-->
<!--<div class="col-lg-3"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Interview+Completed&website=All&keyword=&from_date=&to_date=&search=">Interview Completed : <b style="color:red"> <?php //echo $rowcount_intrvw_completed;?> </b></a></p></div>-->
<!--<div class="col-lg-3"><p style="color:black;font-weight: bold"><a  href = "<?php echo $url_origin; ?>/ls_software/admin/view_all_customer.php?status=Pending+Documents&website=All&keyword=&from_date=&to_date=&search=">Pending Documents : <b style="color:red"> <?php //echo $rowcount_pending_docs;?> </b></a></p></div>-->
...
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Pending&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Pending:<b style="color:red"> <?php echo $rowcount_pending;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Active&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Active:<b style="color:red"> <?php echo $rowcount_loan_active;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Past+Due&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Past Due:<b style="color:red"> <?php echo $rowcount_loan_past;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Payment+Plan&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Payment Plan: <b style="color:red"> <?php echo $rowcount_loan_plan;?> </b></a> </p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Chargeoff&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Chargeoff:<b style="color:red"> <?php echo $rowcount_loan_charge;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Chargeback&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Chargeback:<b style="color:red"> <?php echo $rowcount_chargeback;?></b></a></p></div>





<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Disbursement&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Disbursement:<b style="color:red"> <?php echo $rowcount_disbursement;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Paid&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Paid:<b style="color:red"> <?php echo $rowcount_loan_paid;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Promise+to+Pay&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Promise to Pay: <b style="color:red"> <?php echo $rowcount_promise;?> </b></a> </p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Collections&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Collections:<b style="color:red"> <?php echo $rowcount_collections;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Closed+Account&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Closed Account:<b style="color:red"> <?php echo $rowcount_closed;?></b></a></p></div>
<div class="col-lg-2"><p style="color:black;font-weight: bold"><a  href = "view_specific_payday_loans.php?status=Bankruptcy&keyword=&from_date=&loan_date=&due_date=&to_date=&search=">Bankruptcy:<b style="color:red"> <?php echo $rowcount_bankruptcy;?></b></a></p></div>
