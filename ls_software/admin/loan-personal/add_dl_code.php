...
<div class="row">
    <div class="col-lg-6">
      ...
      <input type="text" name="dl_code" class="form-control" id="lender_description">
      </div>
</div>
<br>
	<button name="btn-code-submit" type="submit" class="btn btn-danger" style="background-image: linear-gradient(to bottom,#95c500 0,#639a0a 100%);
    color: #fff;
    background-color: #2a8206;
    border-color: #112f01;">Add this Code</button>

  </form>
        
        
<?php 
if(isset($_POST['btn-code-submit'])) {
$dl_code =$_POST['dl_code'];
...
window.location.href = 'decision_logic.php?id=<?php echo $id; ?>';
</script> 
