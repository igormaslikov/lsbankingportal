...
$query_payment = mysqli_query($con,"SELECT SUM(payoff_amount) AS value_sum FROM tbl_personal_loan_installments where loan_create_id='$loan_create_id' AND status= '0'");
...
$sql_loan=mysqli_query($con, "select * from tbl_personal_loans where p_loan_id= '$id'"); 
...
<h3>All Upcoming Installments</h3>
...
<th style='width:9%;color:black;'>Payment</th>
<th style='width:11%;color:black;'>Interest</th>
<th style='width:11%;color:black;'>Principal</th>
<th style='width:10%;color:black;'>Balance</th>
<th style='width:22%;color:black;'>Deposite Frequency</th>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `tbl_personal_loan_installments` where loan_create_id='$loan_create_id' AND status='0'");
	$total_records = mysqli_fetch_array($result_count);
	$total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
	$second_last = $total_no_of_pages - 1; // total page minus 1

    $result = mysqli_query($con, "select * from tbl_personal_loan_installments where loan_create_id='$loan_create_id' AND status='0'");
...
else
{
    ...
    $a="<a href='add_new_transaction.php?intallment_id=$intallment_id&id=$id'>PayNow</a>";
}
