...
$sql_source=$con->query("select * from source_income_personal where user_fnd_id = '$user_fnd_id'"); 
...
$sql_doc=$con->query("select * from source_income_personal where user_fnd_id = '$user_fnd_id'"); 
