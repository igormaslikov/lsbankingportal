...
<h3>Payments</h3>
 ...
 <textarea type="text" name="edit_reason"  class="form-control" id="usr" style="margin: 0px -17px 0px 0px; height: 126px; width: 100%;"><?php echo $status;?> </textarea>
     ...
     if(isset($_POST['btn-submit'])) 
{
    ...
    include $_SERVER['DOCUMENT_ROOT'].'/dbconnect.php';
     ...
     $edit_reason= "Payment is Deleted with ID $transaction_id ". $_POST['edit_reason']. " And User ID is $user_fnd_id";
    ...
    if ($delete_allowed==1)
{
       ...
       $query = "DELETE FROM personal_loan_transaction WHERE transaction_id = '$transaction_id'";
