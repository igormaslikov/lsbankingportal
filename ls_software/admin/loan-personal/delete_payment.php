...
<?php
    ...
    $sql_fnd=mysqli_query($con, "select * from tbl_personal_loans where p_loan_id = '$loan_id'"); 
    ...
    if ($delete_allowed==1)
{
   $del_reason="Transaction is Deleted with ID $id_trans AND User ID is $user_fnd_id";
    $query = "DELETE FROM personal_loan_transaction WHERE transaction_id = '$id_trans'";
