...
if ($state=="AZ")
{
$address_contarct="https://pacificafinancegroup.com/loanportal/signature_personal_arizona_customer";
}

if ($state=="NV")
{
$address_contarct="https://pacificafinancegroup.com/loanportal/signature_personal_naveda_customer";
}
...
if($void_img == ''){
    ...
    ';
        ...
        {
        echo "<a onclick='myFunction_contract_manual()' target = '_blank' class='remove-box' href='https://pacificafinancegroup.com/loanportal/ls_software/admin/loan-personal/uploads_contract/$contract_db?id=$id' target='_blank' title='View Contract'>View Echeck Contract</a>";
        }
        else{
