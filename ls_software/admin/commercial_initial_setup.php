   ...
   <div class="row wrapper">
      ...
      function print_schedule($balance, $rate, $payment)
      {
         ...
         do {
            ...
            $query_install1  = "INSERT INTO `tbl_commercial_loan_installments`(`loan_create_id`, `payment`, `interest`, `principal`, `balance`, `payment_date`) VALUES ('$loan_create_id','$payment','$interest','$principal','$balance','$payment_date_weekly')";
            $result_install1 = mysqli_query($con, $query_install1);
            if ($result_install1) {
               //echo "<div class='form'><h3> successfully added in tbl_shipments.</h3><br/></div>";
            } else {
               echo "<h3> Error Inserting Data tbl_commercial_loan_installments</h3>";
            }
