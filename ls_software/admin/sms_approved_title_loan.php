...
$query_sms_content = "select * from msg_template where msg_name='approvedtitleloan' ";
$msg_content = '';
...
$query_update_status= "INSERT INTO `application_status_updates`( `application_id`, `user_id`, `status`, `creation_date`) VALUES ('$cu_id','$u_id','Approved Title Loan SMS Sent','$date')";
