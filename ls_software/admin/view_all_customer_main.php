    ...
    <body>
        ...
        <section class="wrapper" style="font-size:15px !important">
            ...
            <div align="right">
                ...
                <h4 style="float:left;"> Total Applications: <?php echo $rowcount; ?> | <a href="view_all_customer_unread.php">Unread Applications : <?php echo $rowcount_UNREAD; ?> </a></h4>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="font-weight: bold;">
                                ...
                                <select name="status" id="app_status" class="form-control" value="" style="padding: 6px 15px;">
                                    ...
                                    <option value="New Application" <?php if ($_GET['status'] == 'New Application') {
                                                                        echo 'selected';
                                                                    } ?>>New Application</option>
                                    <option value="Declined" <?php if ($_GET['status'] == 'Declined') {
                                                                    echo 'selected';
                                                                } ?>>Declined</option>
                                    <option value="Funded" <?php if ($_GET['status'] == 'Funded') {
                                                                echo 'selected';
                                                            } ?>>Funded</option>
                                    <option value="No Answer" <?php if ($_GET['status'] == 'No Answer') {
                                                                    echo 'selected';
                                                                } ?>>No Answer</option>
                                    ...
                                    <!--<option value="Info Needed"<?php if ($_GET['status'] == 'Info Needed') {
                                                                        echo 'selected';
                                                                    } ?>>Info Needed</option>-->
                                    <!--<option value="Approved Payday NV"<?php if ($_GET['status'] == 'Approved Payday NV') {
                                                                                echo 'selected';
                                                                            } ?>>Approved Payday NV</option>-->
                                    <!--<option value="Approved Commercial CA"<?php if ($_GET['status'] == 'Approved Commercial CA') {
                                                                                    echo 'selected';
                                                                                } ?>>Approved Commercial CA</option>-->
                                    <!--<option value="DL/Bank Needed"<?php if ($_GET['status'] == 'DL/Bank Needed') {
                                                                            echo 'selected';
                                                                        } ?>>DL/Bank Needed</option>-->
                                    <!--<option value="Review Payday NV"<?php if ($_GET['status'] == 'Review Payday NV') {
                                                                            echo 'selected';
                                                                        } ?>>Review Payday NV</option>-->
                                    <!--<option value="Review Commercial CA"<?php if ($_GET['status'] == 'Review Commercial CA') {
                                                                                echo 'selected';
                                                                            } ?>>Review Commercial CA</option>-->
                                    <!--<option value="Credit Report Completed"<?php if ($_GET['status'] == 'Credit Report Completed') {
                                                                                    echo 'selected';
                                                                                } ?>>Credit Report Completed</option>-->
                                    <!--<option value="Decision Logic Completed"<?php if ($_GET['status'] == 'Decision Logic Completed') {
                                                                                    echo 'selected';
                                                                                } ?>>Decision Logic Completed</option>-->
                                    <!--<option value="Credit Report Needed"<?php if ($_GET['status'] == 'Credit Report Needed') {
                                                                                echo 'selected';
                                                                            } ?>>Credit Report Needed</option>-->
                                    <!--<option value="Bank Information Needed"<?php if ($_GET['status'] == 'Bank Information Needed') {
                                                                                    echo 'selected';
                                                                                } ?>>Bank Information Needed</option>-->
                                    <!--<option value="Final Review For Personal Loan"<?php if ($_GET['status'] == 'Final Review For Personal Loan') {
                                                                                            echo 'selected';
                                                                                        } ?>>Final Review For Personal Loan</option>-->
                                    <!--<option value="No Decision Logic For Payday"<?php if ($_GET['status'] == 'No Decision Logic For Payday') {
                                                                                        echo 'selected';
                                                                                    } ?>>No Decision Logic For Payday</option>-->
                                    <!--<option value="Review For Payday"<?php if ($_GET['status'] == 'Review For Payday') {
                                                                                echo 'selected';
                                                                            } ?>>Review For Payday</option>-->
                                    <!--<option value="Approved Payday Loan"<?php if ($_GET['status'] == 'Approved Payday Loan') {
                                                                                echo 'selected';
                                                                            } ?>>Approved Payday Loan</option>-->
                                    <!--<option value="Approved Personal Loan"<?php if ($_GET['status'] == 'Approved Personal Loan') {
                                                                                    echo 'selected';
                                                                                } ?>>Approved Personal Loan</option>-->
                                    <!--<option value="Approved Title Loan"<?php if ($_GET['status'] == 'Approved Title Loan') {
                                                                                echo 'selected';
                                                                            } ?>>Approved Title Loan</option>-->
                                    <!--<option value="Interview Completed"<?php if ($_GET['status'] == 'Interview Completed') {
                                                                                echo 'selected';
                                                                            } ?>>Interview Completed</option>-->
                                    <!--<option value="Pending Documents"<?php if ($_GET['status'] == 'Pending Documents') {
                                                                                echo 'selected';
                            ...
                            <!--<option value="All" <?php if ($_GET['website'] == 'All') {
                                                        echo 'selected';
                                                    } ?>>All Websites</option>-->
                            <!--<option value="lsprestamos"<?php if ($_GET['website'] == 'lsprestamos') {
                                                                echo 'selected';
                                                            } ?>>lsprestamos</option>-->
                            <!--<option value="lspaydayloans"<?php if ($_GET['website'] == 'lspaydayloans') {
                                                                    echo 'selected';
                                                                } ?>>lspaydayloans</option>-->
                            <!--<option value="lsbanking_pdl"<?php if ($_GET['website'] == 'lsbanking_pdl') {
                                                                    echo 'selected';
                                                                } ?>>lsbanking_pdl</option>-->
                            <!--<option value="lsbanking_pl"<?php if ($_GET['website'] == 'lsbanking_pl') {
                                                                echo 'selected';
                                                            } ?>>lsbanking_pl</option>-->
                            <!--<option value="Payday CA"<?php if ($_GET['website'] == 'Payday CA') {
                                                                echo 'selected';
                                                            } ?>>Payday CA</option>-->
                            <!--<option value="mymoneyline_cl"<?php if ($_GET['website'] == 'mymoneyline_cl') {
                                                                    echo 'selected';
                                                                } ?>>mymoneyline_cl</option>-->
                            <!--<option value="mymoneyline_tl"<?php if ($_GET['website'] == 'mymoneyline_tl') {
                                                                    echo 'selected';
                                                                } ?>>mymoneyline_tl</option>-->
                            <!--<option value="Installment CA"<?php if ($_GET['website'] == 'Installment CA') {
                                                                    echo 'selected';
                                                                } ?>>Installment CA</option>-->
                            <!--<option value="Installment Nevada"<?php if ($_GET['website'] == 'Installment Nevada') {
                                                                        echo 'selected';
                                                                    } ?>>Installment Nevada</option>-->
                            <!--<option value="Installment Arizona"<?php if ($_GET['website'] == 'Installment Arizona') {
                                                                        echo 'selected';
                                                                    } ?>>Installment Arizona</option>-->
                            <!--<option value="Installment IL"<?php if ($_GET['website'] == 'Installment IL') {
                                                                    echo 'selected';
                                                                } ?>>Installment IL</option>-->
                            <!--<option value="By Office"<?php if ($_GET['website'] == 'By Office') {
                                                                echo 'selected';
                                                            } ?>>By Office</option>-->
                            <!--</select>-->
                            <!--</td>-->
   ...
   -<a href='view_all_customer_main.php?status=" . $_GET['status'] . "&state=" . $_GET['state'] . "&loan_type=" . $_GET['loan_type'] . "&keyword=" . $_GET['keyword'] . "&from_date=$from_date_filter&to_date=$to_date_filter'>  Today  </a> ";
       ...
       -<a href='view_all_customer_main.php?status=" . $_GET['status'] . "&state=" . $_GET['state'] . "&loan_type=" . $_GET['loan_type'] . "&keyword=" . $_GET['keyword'] . "&from_date=$from_date_filter&to_date=$to_date_filter'> This Year  </a> ";
                        ...
                        <tbody>
                            ...
                            $query_main_search = "select * from fnd_user_profile_submission where ";
                            ...
                            while ($row_fnd_idd = mysqli_fetch_array($sql_fnd_idd)) {
                                ...
                                //	echo "<br><br><br><br><br><br>". $user_fnd_idd;
...
<a href='customer_loan_history.php?id=$id'  title='Loan History'><span class='glyphicon glyphicon-collapse-up' aria-hidden='true' alt='Loan History'></span>  <span style = 'color:green; text-align:left'></span></a>
                    ...
                    <ul class="pagination">
                        ...
                        <li <?php if ($page_no <= 1) {
                            ...
                            <a <?php if ($page_no > 1) {
                                    echo "href='?page_no=$previous_page&$delete_customer_pagination'";
                                } ?>>Previous</a>
                        </li>
                        ...
                        <li <?php if ($page_no >= $total_no_of_pages) {
                            ...
                            <a <?php if ($page_no < $total_no_of_pages) {
                                    echo "href='?page_no=$next_page&$delete_customer_pagination'";
                                } ?>>Next</a>
                        </li>
