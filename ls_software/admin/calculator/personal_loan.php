...
<?php include('menu.php') ;?>
  ...
  <label for="usr"> Select Loan Type :   </label>
    ...
    <option value=""></option>
    <option value="http://lsbankingportal.com/ls_software/admin/calculator/payday_loan.php" >Payday Loan</option>
    <option value="http://lsbankingportal.com/ls_software/admin/calculator/personal_loan.php" selected>Personal Loan</option>
</select>
