...
<?php include('../menu.php') ;?>
  ...
  <label for="usr"> Select Loan Type :   </label>
    ...
    <option value=""></option>
    <option value="https://ofsca.com/loanportal/ls_software/admin/calculator/payday_loan.php" selected>Payday Loan</option>
    <option value="https://ofsca.com/loanportal/ls_software/admin/calculator/personal_loan.php">Personal Loan</option>
</select>
...
<br>
  ...
  $loan_fee = (float)$_POST['loan_fee'];
  $repayment_time = (float)$_POST['repayment_time'];

  if ($loan_amount > 0 && $repayment_time > 0) {
