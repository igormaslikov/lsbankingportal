...
<iframe src="https://lsbankingportal.com/ls_software/admin/sms-chat/chat.php?admin_name=<?php echo $u_name;?>&fnd_id=<?php echo $cu_id ;?>&customer_name=<?php echo $first_name;?>" height="500px" width="100%" id="conversation"></iframe>