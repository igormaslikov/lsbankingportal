...
<nav class="navbar navbar-default navbar-fixed-top top-menu lsbanking" style="background-image: linear-gradient(to bottom,#1E90FF 0,#1E90FF 100%); font-weight:600 ;font-size:20px">
      <div class="" style="width:98%">
        ...
        <div id="navbar" class="navbar-collapse collapse" style="float:right; position:relative; display:block; width:100%">
          <ul class="nav navbar-nav nav1" style="flex-direction:row !important; ">
            <a class="navbar-brand" href="https://ofsca.com/loanportal/ls_software/admin/home.php" style="color:white;"><span class="glyphicon glyphicon-home" style="font-size:20px;color:white"></span></a>
            <li class="loan"><a href="https://ofsca.com/loanportal/ls_software/admin/view_all_customer.php?status=All&keyword=&from_date=&to_date=&search=&website=All"  style="color:white; font-size:20px">Applications</a></li>
            <li class="loan"><a href="https://ofsca.com/loanportal/ls_software/admin/view_all_payday_loans.php" style="color:white;">Payday Loans</a></li>
            <li class="loan"><a href="#"  style="color:white;">Personal Loans</a></li>
            <li class="loan"><a href="#"  style="color:white;">Reports</a></li>
            <li class="loan"><a href="https://ofsca.com/loanportal/ls_software/admin/marketing.php"  style="color:white;">Marketing</a></li>
    ...
    <li class = "loan"><a  href='#' title='Menu' style="font-size:20px">Settings</a>
      <ul class='menus'>
        <li><a href="https://ofsca.com/loanportal/ls_software/admin/sms_settings.php"  style="color:white;" title='Dropdown 1'>SMS Settings</a>
        </li>
        <li class="portfolio"><a href="https://ofsca.com/loanportal/ls_software/admin/view_all_companies.php"  style="color:white;">Portfolios</a></li>
        <li class="user"><a href="https://ofsca.com/loanportal/ls_software/admin/view_all_user.php"  style="color:white;">User</a></li>
    ...
    <li class="loan"><a  href='#' title='Menu' style="font-size:20px">Tools</a>
      <ul class='menus'>
        ...
        <li class="loan"><a href="https://ofsca.com/loanportal/ls_software/admin/calculator/payday_loan.php"  style="color:white;">Calculator</a></li>
        <li class="loan"><a href="https://ofsca.com/loanportal/ls_software/admin/view_all_credit_reports.php"  style="color:white;">View All Credit Reports</a></li>
