...
$sql_bank_detail=mysqli_query($con, "select * from tbl_bank_cards where bank_id = '$bank_id'"); 
    ...
    if ($update_allowed==1)
{
      ...
      mysqli_query($con, "UPDATE tbl_bank_cards SET type_of_card='$type_card_up', card_number='$card_number_up', card_exp_date='$card_exp_date_up', routing_number='$routing_number_up', account_number='$account_number_up', cvv_number='$cvv_number_up' where bank_id='$bank_id' ");
...
<input type="text" name="link" value="<?php echo $message;?>" style="display:none;">
 ...
 <!--   </div> -->
    ...
    <div class="col-lg-6">
     ...
     <button name="btn-submit" type="submit" class="btn btn-danger" style="background-image: linear-gradient(to bottom,#1E90FF 0,#1E90FF 100%);color: white;background-color: #1E90FF;border-radius: 0px;border-color: #1E90FF;">Update Card Info</button>
