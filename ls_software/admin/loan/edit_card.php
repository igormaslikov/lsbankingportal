...
$sql_bank_detail=$con->query("select * from tbl_bank_cards where bank_id = '$bank_id'"); 
    ...
    if ($update_allowed==1)
{
      ...
      $con->query("UPDATE tbl_bank_cards SET type_of_card='$type_card_up', card_number='$card_number_up', card_exp_date='$card_exp_date_up', routing_number='$routing_number_up', account_number='$account_number_up', cvv_number='$cvv_number_up' where bank_id='$bank_id' ");
