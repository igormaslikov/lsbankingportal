...
//$result_status_update = $con->query($query_update_status);
  ...
  $con->query("UPDATE tbl_loan SET loan_status ='Active' where  loan_id='$id' AND loan_create_id='$loan_create_id'");
  
  
      $con->query("UPDATE fnd_user_profile SET application_status='Funded' WHERE user_fnd_id = '$user_fnd_id'");
    $con->query("UPDATE tbl_loan SET fund_status='1' WHERE loan_create_id = '$loan_create_id'");
    $application_id = "";
