...
if($sign_status>0){
    ...
    $signed_button_payday .= '<a target="_blank" href="https://ofsca.com/loanportal/signature_customer/files/sign_contract.php?id='.$mail_key.'" title=""><i class="glyphicon glyphicon-search" alt="" title="Preview The Payday Contract"></i></a>';
