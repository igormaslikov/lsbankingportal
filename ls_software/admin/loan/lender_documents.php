...
<div class="col-lg-3"><p>Created By:<b style="color:red"> <?php echo $username;?> </b> </p></div>
...
<div class="row">
    <div class="col-lg-6">
      ...
      <input type="text" name="description" class="form-control" id="lender_description">
      </div>
      <div class="col-lg-6">
...
<br>
    ...
    border-color: #112f01;">Upload File</button>
