...
$arrlength = count($email_keys);
        ...
        for($x = 0; $x < $arrlength; $x++) {  
            ...
            echo "<div><a target='_blank' href='https://mymoneyline.com/lsbankingportal/signature_customer/files/sign_contract.php?id=$email_keys[$x]'><span class='glyphicon glyphicon-file' title='Contract' aria-hidden='true' alt='Contract'></span></a></div></div>";
         }
