            ...
            <tbody>
              ...
              while ($row_loan_his = mysqli_fetch_array($sql_loan_his)) {
                ...
                for ($x = 0; $x < $arrlength; $x++) {
                  ...
                  echo "<div><a target='_blank' href='https://www.mymoneyline.com/lsbankingportal/signature_customer/files/sign_contract.php?id=$email_keys[$x]'><span class='glyphicon glyphicon-file' title='Contract' aria-hidden='true' alt='Contract'></span></a></div></div>";
                }
