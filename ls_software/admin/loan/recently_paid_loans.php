...
$query_us = mysqli_query($con,"SELECT SUM(amount_of_loan) AS value_sum FROM tbl_loan where loan_status='Paid' AND last_payment_date >='$date_last_7days'");
...
$query_le = mysqli_query($con,"SELECT SUM(loan_total_payable) AS value_sum FROM tbl_loan where loan_status='Paid' AND last_payment_date >='$date_last_7days'");
...
$sql=mysqli_query($con, "select * from tbl_loan where loan_status='Paid' AND last_payment_date >='$date_last_7days'"); 
$total_loan_fee="0";
...
$total_records_per_page = 200;
	...
	$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `tbl_loan` where loan_status='Paid' AND last_payment_date >='$date_last_7days'");
...
break;
   // echo"<br>User_Key:" .$payment;
        ...
        $result_user_totalloan = mysqli_query($con,"Select * from `tbl_loan` where user_fnd_id = '$user_fnd_id' AND loan_status='Paid' AND last_payment_date >='$date_last_7days'");
        $total_loans_lh = 0;
