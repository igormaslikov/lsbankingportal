...
$sql=mysqli_query($con, "select * from `tbl_loan` where `sign_status` = '1' AND `payment_date` >= CURDATE() AND `loan_status`!='Paid' ORDER BY `payment_date` ASC"); 
$total_loan_fee="0";
...
$query_search = "select * from `tbl_loan` where `sign_status` = '1' AND `payment_date` >= CURDATE() AND `loan_status`!='Paid' ORDER BY `payment_date` ASC";
