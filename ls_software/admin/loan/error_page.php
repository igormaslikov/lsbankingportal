...
<div class="col-lg-3"><p>User ID:<b style="color:red"> <?php echo $user_fnd_id;?> </b> </p></div>
      ...
      <br><br>
        ...
        <h3>Error Code Does't Match, Please Enter Correct Code! </h3>

      <br><br>
      
     <a href="add_auth_code.php?id=<?php echo $id;?>"><button name='btn-submit' type='submit' class='btn btn-danger' style='color: #fff;background-color: blue;border-color: blue;'>Go Back</button></a>
</div>
</div>
</div>
