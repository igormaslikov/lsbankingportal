...
<div class="row">
   <div class="col-lg-6">
      <label for="usr">PTP</label>
     <input type="text" name="note_ptp" id="date1" alt="date" class="IP_calendar form-control"  id="usr" title="d/m/Y">
    </div>
...
<br>
	<button name="btn-submit-ptp" type="submit" class="btn btn-danger" style="background-image: linear-gradient(to bottom,#95c500 0,#639a0a 100%);
    color: #fff;
    background-color: #2a8206;
    border-color: #112f01;">Add PTP</button>
...
window.location.href = 'view_all_ptp.php?id=<?php echo $id; ?>';
</script> 
