          ...
          //difference between two dates
           ...
           //count days
              ...
              if ($last_payment_date == "" || $last_payment_date== '01-01-1970') {
                  ...
                  $query_payment = $con->query("SELECT * FROM loan_transaction where loan_id= '$id' AND payoff_amount>1");
                  while ($row_payment = $query_payment->fetch_array()) {
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
   ...
   $sql_loan=$con->query("select * from loan_transaction where loan_id='$id' Order By transaction_id DESC"); 
    ...
    if ($update_allowed==1)
{
      ...
      $con->query("UPDATE tbl_loan SET amount_of_loan ='$amount_loan_up', loan_total_payable ='$amount_left_up', payment_date ='$next_payment_date_up', loan_status='$account_status', secondary_portfolio='$portfolio', days_past_due='$days_past_due', apr='$apr_up'  where user_fnd_id ='$user_fnd_id' AND loan_id='$id'");
