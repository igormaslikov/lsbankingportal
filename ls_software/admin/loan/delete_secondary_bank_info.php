    ...
    if ($delete_allowed==1)
{
    ...
    $query = "DELETE FROM loan_initial_banking WHERE loan_id = '$loan_create_id' AND initial_id= '$bank_id' AND primary_status='0'";
    $result = mysqli_query($con, $query);
      ...
      $bank_account_statuss= "Secondary Bank Account is Deleted by $username";
      $transaction_id="";
...
window.location.href = 'banking_detail.php?id=<?php echo $id; ?>';
</script>
