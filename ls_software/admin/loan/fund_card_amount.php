...
window.location.href = 'fund_card_api.php?id=<?php echo $id;?>&amount_to_pay=<?php echo $amount_to_pay;?>';
</script>
  <?php
}
?> 
...
<div class="col-lg-3"><p>User ID:<b style="color:red"> <?php echo $user_fnd_id;?> </b> </p></div>
  ...
  <div class="row">
          ...
          <div class='col-lg-6'>
      <label for='usr'>Fund Amount</label>
    ...
    <br>
    <button name='btn-paynow' type='submit' class='btn btn-danger' style='color: #fff;background-color: blue;border-color: blue;'>Fund Now</button>
