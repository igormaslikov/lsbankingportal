...
<div  style="float:right;color:black;font-size:18px">Uncollected Payments: <span style="color:red;"><?php $uncollect=$pay_off-$totall_trans; if ($uncollect>0) {echo $varibl.number_format("$uncollect",2);} ?> </span> </div>
