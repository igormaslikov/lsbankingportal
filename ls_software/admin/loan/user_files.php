...
?>
  ...
  <body>
    ...
    ';
        ...
        <td><a onclick='myFunction_contract()' target = '_blank' href='https://www.ofsca.com/loanportal/signature_customer/files/sign_contract.php?id=$mail_key' target='_blank' title='View Contract'>View Contract</a>" ?><?php
                                                                                                                                                                                                                                                          echo "<br><br>";
