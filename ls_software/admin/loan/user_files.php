...
?>
  ...
  <body>
    ...
    ';
        ...
        <td><a onclick='myFunction_contract()' target = '_blank' class='remove-box' href='https://www.pacificafinancegroup.com/loanportal/signature_customer/files/sign_contract.php?id=$mail_key' target='_blank' title='View Contract'>View Contract</a>" ?><?php
                                                                                                                                                                                                                                                          echo "<br><br>";
                                                                                                                                                                                                                                                          if ($contract_status == '1') {
                                                                                                                                                                                                                                                            echo "<a onclick='myFunction_contract_manual()' target = '_blank' class='remove-box' href='https://pacificafinancegroup.com/loanportal/ls_software/admin/loan/uploads_contract/$contract_db?id=$id' target='_blank' title='View Contract'>View Manual Contract</a>";
                                                                                                                                                                                                                                                          } else {
