...
?>
  ...
  <body>
    ...
    ';
        ...
        <td><a onclick='myFunction_contract()' target = '_blank' class='remove-box' href='https://www.mymoneyline.com/lsbankingportal/signature_customer/files/sign_contract.php?id=$mail_key' target='_blank' title='View Contract'>View Contract</a>" ?><?php
                                                                                                                                                                                                                                                          echo "<br><br>";
