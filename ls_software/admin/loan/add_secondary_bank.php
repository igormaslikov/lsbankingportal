     ...
     if(isset($_POST['btn-submit'])) 
{
    ...
    $card_exp_date = $expiry_month_card. "/".$expiry_year_card;
     ...
     $query_in  = "INSERT INTO loan_initial_banking (loan_id,user_fnd_id,type_of_card,card_number,card_exp_date,bank_name,routing_number,account_number,cvv_number,creation_date,created_by,primary_status)  VALUES ('$loan_create_id','$user_fnd_id','$type_card','$card_number','$card_exp_date','$bank_name','$routing_number','$account_number','$cvv_number','$date','$u_id','0')";
...
$username=$row_access['username'];
	...
	//	echo "<br><br><br><br><br><br>". $access_level_name;
      ...
      $bank_account_statuss= "Secondary Bank Account is Created by $username";
      $transaction_id="";
...
<div class="row">
    <div class="col-lg-6" >
  <h3> Add Secondary Bank Information</h3>
  </div>
</div>
<br>
  <div class="row">
 ...
 <!--   </div> -->
   ...
   <div class="col-lg-6">
     ...
     <option value="Meta Bank">Meta Bank</option>
     </select>
    ...
    <div class="col-lg-6">
      ...
      <input type="text" name="routing_number"  class="form-control" id="usr" value="" required>
    </div>
    
    <div class="col-lg-6">
      <label for="usr">Account Number*</label>
      <input type="text" name="account_number"  class="form-control" id="usr" value="" required>
    </div>
    ...
    <div class="col-lg-6">
      ...
      <button name="btn-submit" type="submit" class="btn btn-danger" style="background-image: linear-gradient(to bottom,#1E90FF 0,#1E90FF 100%);color: white;background-color: #1E90FF;border-radius: 0px;border-color: #1E90FF;">Add Secondary Bank Info</button>
    </form>
